...
from qcom.db.models import Conversation, engine
from qcom.index.file.ui import File
from qcom.reasoning.prompt_optimization.mindmap import MINDMAP_HTML_EXPORT_TEMPLATE
from qcom.reasoning.prompt_optimization.suggest_conversation_name import (
    SuggestConvNamePipeline,
)
# from qcom.reasoning.prompt_optimization.suggest_followup_chat import (
    ...
    def on_building_ui(self):
        with gr.Row():
            ...
            with gr.Column(scale=1, elem_id="conv-settings-panel") as self.conv_column:
                ...
                with gr.Accordion(label="Related papers", open=False, visible=False):
