...
import gradio as gr
import pluggy
from qcom import extension_protocol
from qcom.assets import PDFJS_PREBUILT_DIR, KotaemonTheme
from qcom.components import reasonings
from qcom.exceptions import HookAlreadyDeclared, HookNotDeclared
from qcom.index import IndexManager
from qcom.settings import BaseSettingGroup, SettingGroup, SettingReasoningGroup
...
class BaseApp:
    ...
    def __init__(self):
        ...
        self.app_name = getattr(settings, "KH_APP_NAME", "Internal Assistant")
        ...
        self._favicon = str(dir_assets / "img" / "q_favicon.ico")
    ...
    def register_extensions(self):
        ...
        self.exman = pluggy.PluginManager("qcom")
        self.exman.add_hookspecs(extension_protocol)
        self.exman.load_setuptools_entrypoints("qcom")
