...
from qcom.app import BaseApp
from qcom.pages.chat import ChatPage
from qcom.pages.resources import ResourcesTab
from qcom.pages.settings import SettingsPage
...
class App(BaseApp):
    ...
    def on_subscribe_public_events(self):
        if self.f_user_management:
            from qcom.db.engine import engine
            from qcom.db.models import User
