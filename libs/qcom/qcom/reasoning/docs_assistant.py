...
from qcom.embeddings.manager import embedding_models_manager as embeddings
from qcom.llms.manager import llms
from qcom.reasoning.prompt_optimization import (
    # DecomposeQuestionPipeline,
    RewriteQuestionPipeline,
)
from qcom.utils.render import Render
from qcom.utils.visualize_cited import CreateCitationVizPipeline
...
class FullQAPipeline(BaseReasoning):
    ...
    def get_pipeline(cls, settings, states, retrievers):
        ...
        answer_pipeline.enable_citation_viz = False #settings[f"{prefix}.create_citation_viz"]
        answer_pipeline.use_multimodal = False#settings[f"{prefix}.use_multimodal"]
