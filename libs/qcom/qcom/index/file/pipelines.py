...
from qcom.db.models import engine
from qcom.embeddings.manager import embedding_models_manager
from qcom.llms.manager import llms
# from qcom.rerankings.manager import reranking_models_manager
...
class DocumentRetrievalPipeline(BaseFileIndexRetriever):
    ...
    def get_pipeline(cls, user_settings, index_settings, selected):
        ...
        retriever = cls(
            ...
            llm_scorer= None,#(LLMTrulensScoring() if use_llm_reranking else None),
            rerankers=[]
        )
