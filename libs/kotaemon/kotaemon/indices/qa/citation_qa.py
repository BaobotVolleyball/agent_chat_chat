...
try:
    ...
    from qcom.reasoning.prompt_optimization.mindmap import CreateMindmapPipeline
    from qcom.utils.render import Render
except ImportError:
    raise ImportError("Please install `qcom` to use this component")
...
DEFAULT_QA_TEXT_PROMPT = (
    "Dựa trên thông tin cung cấp dưới đây để trả lời câu hỏi. "
    "Nếu không có thông tin về câu hỏi, hãy trả lời tôi không biết. "
    "Hãy trả lời bằng ngôn ngữ "
    "{lang}.\n\n"
    "{context}\n"
